...
public final class Encoder2 implements AutoCloseable {

    private final OutputStream outputStream;
    private final byte[] buf;
    private final ByteBuffer bb;

    public Encoder2(final OutputStream outputStream) {
        this(outputStream, Options.standard());
    }

    public Encoder2(final OutputStream outputStream, final Options options) {
        buf = new byte[8];
